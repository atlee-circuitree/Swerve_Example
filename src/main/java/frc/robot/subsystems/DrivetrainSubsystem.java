...
import frc.robot.common.Mk3SwerveModule;
import frc.robot.common.Pigeon;
import frc.robot.common.HolonomicDriveSignal;
...
public class DrivetrainSubsystem implements Subsystem, UpdateManager.Updatable {
    ...
    @javax.annotation.concurrent.GuardedBy("kinematicsLock")
